...
// PG_FAILSAFE_CONFIG
    ...
    { "pats_rcloss_reboot_delay",      VAR_UINT16 | MASTER_VALUE, .config.minmaxUnsigned = { 0, 6000 }, PG_FAILSAFE_CONFIG, offsetof(failsafeConfig_t, pats_rcloss_reboot_delay) },
...
// PG_PID_PROFILE
    ...
    { "level_limit",                VAR_UINT8  | PROFILE_VALUE, .config.minmaxUnsigned = { 10, 180 }, PG_PID_PROFILE, offsetof(pidProfile_t, levelAngleLimit) },
