...
#define PATS_HEADLESS_DISABLE_MIN 1031
#define PATS_HEADLESS_DISABLE_MAX 1063
#define PATS_YAW_RESET_MIN PATS_HEADLESS_DISABLE_MAX
#define PATS_YAW_RESET_MAX 1095
#define PID_LOOP_DISABLED_MIN PATS_YAW_RESET_MAX
#define PID_LOOP_DISABLED_MAX 1126
#define PATS_DIRECT_SPIN_MOTOR_MIN PID_LOOP_DISABLED_MAX
#define PATS_DIRECT_SPIN_MOTOR_MAX 1158
#define PATS_DIRECT_SPIN_MOTOR_REVERSED_MIN PATS_DIRECT_SPIN_MOTOR_MAX
#define PATS_DIRECT_SPIN_MOTOR_REVERSED_MAX 1190
#define PATS_AIRMODE_MIN PATS_DIRECT_SPIN_MOTOR_MAX
#define PATS_AIRMODE_MAX 1222
#define PATS_SLEEP_MIN PATS_AIRMODE_MAX
#define PATS_SLEEP_MAX 1253
